...
const AuthLayout = ({ children }) => {
  return (
    <div className="min-h-screen bg-[#020617] flex flex-col lg:row overflow-hidden font-sans selection:bg-brand-cyan/30">
...
const FeatureItem = ({ icon, title, desc, color }) => (
  <div className="flex items-start gap-4 p-4 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-white/10 transition-all group cursor-default">
    ...
    <div>
      <h4 className="text-sm font-bold text-white group-hover:text-brand-cyan transition-colors">{title}</h4>
