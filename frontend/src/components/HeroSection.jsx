        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <Link to="/home#roadmaps" className="px-8 py-4 rounded-2xl bg-white/5 border border-white/10 text-white font-bold flex items-center gap-2 hover:bg-white/10 transition-all">
                Explore Roadmaps
              </Link>
            </div>
