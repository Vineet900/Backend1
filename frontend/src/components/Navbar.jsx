      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <Link to="/home" className="flex items-center gap-2 group">
            ...
            <span className="text-xl font-extrabold tracking-tight bg-gradient-to-r from-white to-white/70 bg-clip-text text-transparent group-hover:to-brand-cyan transition-all">
          ...
          <div className="flex items-center gap-3">
            <div className="hidden sm:flex relative group">
              ...
              <input 
                type="text" 
                placeholder="Search..." 
                className="bg-white/5 border border-white/10 rounded-full pl-10 pr-4 py-1.5 text-sm focus:outline-none focus:ring-1 focus:ring-brand-cyan/50 focus:bg-white/10 transition-all w-32 lg:w-48"
              />
            </div>
                ...
                {isUserMenuOpen && (
                  ...
                  >
                    <div className="p-3 border-b border-white/5 mb-1">
                      <p className="text-sm font-bold text-white truncate">{state.user?.name || 'Guest'}</p>
                      <p className="text-xs text-white/40 truncate">Level {Math.max(1, Math.floor((state.xp || 0) / 120) + 1)} Learner</p>
                    </div>
                    <Link to="/profile" className="flex items-center gap-3 px-3 py-2 text-sm text-white/70 hover:text-white hover:bg-white/5 rounded-xl transition-all">
                      <User size={16} /> Profile
                    </Link>
                    <Link to="/settings" className="flex items-center gap-3 px-3 py-2 text-sm text-white/70 hover:text-white hover:bg-white/5 rounded-xl transition-all">
            ...
            <button 
              ...
              className="md:hidden p-2 text-white hover:bg-white/5 rounded-full"
            >
              ...
              <div className="pt-4 border-t border-white/5">
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-xl pl-10 pr-4 py-3 text-sm focus:outline-none focus:ring-1 focus:ring-brand-cyan/50"
                  />
                </div>
              </div>
            </div>
