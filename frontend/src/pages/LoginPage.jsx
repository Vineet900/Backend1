      ...
      <div className="w-full">
        ...
        <div className="flex p-1 bg-white/5 rounded-2xl mb-10 border border-white/5">
          <button 
            ...
            className={`flex-1 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${tab === 'signIn' ? 'bg-brand-cyan text-bg-deep shadow-lg shadow-brand-cyan/20' : 'text-white/40'}`}
          >
            Sign In
          </button>
          <button 
            onClick={() => { setTab('signUp'); setStep('info'); }} 
            className={`flex-1 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${tab === 'signUp' ? 'bg-brand-purple text-white shadow-lg shadow-brand-purple/20' : 'text-white/40'}`}
          >
            Join Orbit
          </button>
        </div>
          ...
          {step === 'info' ? (
            ...
            >
              ...
              <div className="pt-6">
                <div className="relative mb-8">
                  ...
                  <div className="relative flex justify-center text-[10px] font-bold uppercase tracking-widest text-white/20"><span className="bg-[#020617] px-4">Secure Neural Links</span></div>
                </div>
            ...
            >
              <div className="text-center">
                ...
                <h2 className="text-2xl font-black text-white mb-2">Neural Handshake</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="text-center space-y-4">
                  ...
                  <button 
                    ...
                    className="flex items-center justify-center gap-2 text-white/30 text-[10px] font-black uppercase tracking-widest hover:text-white mx-auto transition-all"
                  >
...
const SocialButton = ({ icon, onClick }) => (
  <button 
    type="button"
    onClick={onClick}
    className="flex items-center justify-center p-4 rounded-2xl bg-white/5 border border-white/10 text-white/40 hover:text-white hover:bg-white/10 hover:border-white/20 transition-all active:scale-95 group"
  >
